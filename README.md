...
📄 **Full write-up (problem framing, design rationale, what I'd build next):** [Notion case study](https://app.notion.com/p/Case-Study-Live-Return-Intelligence-Prioritisation-Engine-ba6b2fef471b4b418547d0682fcdcb56?source=copy_link) — also included in this repo as `LRIPE-CASE-STUDY.md`.
